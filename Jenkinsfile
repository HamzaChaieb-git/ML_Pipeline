                ...
                script {
                    retry(3) {
                        sh '''
                            ...
                            # Copy MLflow database to the working directory (generated by main.py/model_pipeline.py)
                            # Note: Ensure main.py or model_pipeline.py logs to a local MLflow.db file
                            cp $(pwd)/${MLFLOW_DB} $(pwd)/${MLFLOW_DB}.backup || true
